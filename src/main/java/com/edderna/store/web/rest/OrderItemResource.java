...
import com.edderna.store.repository.OrderItemRepository;
import com.edderna.store.service.OrderItemService;
...
/**
 * REST controller for managing {@link com.edderna.store.domain.OrderItem}.
 */
@RestController
@RequestMapping("/api")
