...
public class InvoiceService {
    ...
    /**
     *  Get all the invoices where Order is {@code null}.
     *  @return the list of entities.
     */
    @Transactional(readOnly = true)
    public Flux<Invoice> findAllWhereOrderIsNull() {
        log.debug("Request to get all invoices where Order is null");
        return invoiceRepository.findAllWhereOrderIsNull();
    }
