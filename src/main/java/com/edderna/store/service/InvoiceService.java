...
public class InvoiceService {
    ...
    /**
     *  Get all the invoices where Id is {@code null}.
     *  @return the list of entities.
     */
    @Transactional(readOnly = true)
    public Flux<Invoice> findAllWhereIdIsNull() {
        log.debug("Request to get all invoices where Id is null");
        return invoiceRepository.findAllWhereIdIsNull();
    }
