        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField id="order-item-product" name="productId" data-cy="product" label="Product" type="select" required>
                <option value="" key="0" />
                {products
              ...
              <ValidatedField id="order-item-order" name="orderId" data-cy="order" label="Order" type="select" required>
                <option value="" key="0" />
                {orders
