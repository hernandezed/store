          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('quantityPerPackage')}>
                  <Translate contentKey="storeApp.product.quantityPerPackage">Quantity Per Package</Translate>{' '}
                ...
                <th className="hand" onClick={sort('stock')}>
                  <Translate contentKey="storeApp.product.stock">Stock</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
