...
import static com.edderna.store.web.rest.TestUtil.sameNumber;
...
import com.edderna.store.repository.ProductRepository;
...
class ProductResourceIT {
    ...
    private static final Integer DEFAULT_QUANTITY_PER_PACKAGE = 1;
    private static final Integer UPDATED_QUANTITY_PER_PACKAGE = 2;
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product()
            ...
            .quantityPerPackage(DEFAULT_QUANTITY_PER_PACKAGE)
            .price(DEFAULT_PRICE)
            .image(DEFAULT_IMAGE)
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product()
            ...
            .quantityPerPackage(UPDATED_QUANTITY_PER_PACKAGE)
            .price(UPDATED_PRICE)
            .image(UPDATED_IMAGE)
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getQuantityPerPackage()).isEqualTo(DEFAULT_QUANTITY_PER_PACKAGE);
    ...
    @Test
    @Transactional
    void checkQuantityPerPackageIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
        product.setQuantityPerPackage(null);
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].quantityPerPackage").value(hasItem(DEFAULT_QUANTITY_PER_PACKAGE)))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.quantityPerPackage").value(DEFAULT_QUANTITY_PER_PACKAGE))
    ...
    void putNewProduct() throws Exception {
        ...
        assertThat(testProduct.getQuantityPerPackage()).isEqualTo(UPDATED_QUANTITY_PER_PACKAGE);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.image(UPDATED_IMAGE).imageContentType(UPDATED_IMAGE_CONTENT_TYPE).stock(UPDATED_STOCK);
